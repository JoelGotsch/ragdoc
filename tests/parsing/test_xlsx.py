...
from ragdoc.parsing import load_file, ExcelPackage, ExcelConfig
from ragdoc.document import Document
import pandas as pd

def test_xlsx(xlsx_file_path: Path):
    config = ExcelConfig(sheet_params={
        "Sheet1": {},
        "Example": {"skiprows": 3},
    })
...
def test_xlsx_multiline(xlsx_file_path: Path):
    ...
    assert df.columns.tolist() == [('this is a multiline header', 'col1'), ('this is a multiline header', 'col2'), ('this is a multiline header', 'col3')]
